set moduleName allo_DDitBlock_Pipeline_l_m_fused_i5_l_j332
set isTopModule 0
...
set C_modelName {allo_DDitBlock_Pipeline_l_m_fused_i5_l_j332}
set C_modelType { void 0 }
set C_modelArgList {
	{ buffer_Q float 32 regular {array 524288 { 1 0 } 1 1 }  }
	{ buffer4 float 32 regular {array 512 { 1 3 } 1 1 }  }
	{ buffer3 float 32 regular {array 512 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "buffer_Q", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "buffer4", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "buffer3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ buffer4_address0 sc_out sc_lv 9 signal 1 } 
	{ buffer4_ce0 sc_out sc_logic 1 signal 1 } 
	{ buffer4_q0 sc_in sc_lv 32 signal 1 } 
	{ buffer3_address0 sc_out sc_lv 9 signal 2 } 
	{ buffer3_ce0 sc_out sc_logic 1 signal 2 } 
	{ buffer3_q0 sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buffer4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "buffer4", "role": "address0" }} , 
 	{ "name": "buffer4_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buffer4", "role": "ce0" }} , 
 	{ "name": "buffer4_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buffer4", "role": "q0" }} , 
 	{ "name": "buffer3_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "buffer3", "role": "address0" }} , 
 	{ "name": "buffer3_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buffer3", "role": "ce0" }} , 
 	{ "name": "buffer3_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buffer3", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "allo_DDitBlock_Pipeline_l_m_fused_i5_l_j332",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "buffer_Q", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "buffer4", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "buffer3", "Type" : "Memory", "Direction" : "I"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	allo_DDitBlock_Pipeline_l_m_fused_i5_l_j332 {
		buffer_Q {Type IO LastRead 3 FirstWrite 10}
		buffer4 {Type I LastRead 0 FirstWrite -1}
		buffer3 {Type I LastRead 5 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	buffer_Q { ap_memory {  { buffer_Q_address0 mem_address 1 19 }  { buffer_Q_ce0 mem_ce 1 1 }  { buffer_Q_q0 mem_dout 0 32 }  { buffer_Q_address1 MemPortADDR2 1 19 }  { buffer_Q_ce1 MemPortCE2 1 1 }  { buffer_Q_we1 MemPortWE2 1 1 }  { buffer_Q_d1 MemPortDIN2 1 32 } } }
	buffer4 { ap_memory {  { buffer4_address0 mem_address 1 9 }  { buffer4_ce0 mem_ce 1 1 }  { buffer4_q0 mem_dout 0 32 } } }
	buffer3 { ap_memory {  { buffer3_address0 mem_address 1 9 }  { buffer3_ce0 mem_ce 1 1 }  { buffer3_q0 mem_dout 0 32 } } }
}
