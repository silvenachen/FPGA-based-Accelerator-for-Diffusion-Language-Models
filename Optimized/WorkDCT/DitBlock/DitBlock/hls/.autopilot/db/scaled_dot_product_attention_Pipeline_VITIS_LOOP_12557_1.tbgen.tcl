set moduleName scaled_dot_product_attention_Pipeline_VITIS_LOOP_12557_1
set isTopModule 0
...
set C_modelName {scaled_dot_product_attention_Pipeline_VITIS_LOOP_12557_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ M float 32 regular {array 1024 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	M { ap_memory {  { M_address0 mem_address 1 10 }  { M_ce0 mem_ce 1 1 }  { M_we0 mem_we 1 1 }  { M_d0 mem_din 1 32 } } }
}
