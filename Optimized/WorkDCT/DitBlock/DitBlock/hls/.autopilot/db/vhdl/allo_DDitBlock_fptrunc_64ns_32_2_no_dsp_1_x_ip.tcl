...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name allo_DDitBlock_fptrunc_64ns_32_2_no_dsp_1_x_ip
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name allo_DDitBlock_fptrunc_64ns_32_2_no_dsp_1_x_ip \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips allo_DDitBlock_fptrunc_64ns_32_2_no_dsp_1_x_ip] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files allo_DDitBlock_fptrunc_64ns_32_2_no_dsp_1_x_ip.xci]
generate_target {synthesis simulation} [get_files allo_DDitBlock_fptrunc_64ns_32_2_no_dsp_1_x_ip.xci]
