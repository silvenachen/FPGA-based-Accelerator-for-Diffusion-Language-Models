...
set name allo_DDitBlock_fadd_32ns_32ns_32_3_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fadd} IMPL {fulldsp} LATENCY 2 ALLOW_PRAGMA 1
}


set name allo_DDitBlock_fmul_32ns_32ns_32_2_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_v4_0_0 \
    op interface \
    ports { v4_0_0 { O 32 vector } v4_0_0_ap_vld { O 1 bit } } \
} "
}
