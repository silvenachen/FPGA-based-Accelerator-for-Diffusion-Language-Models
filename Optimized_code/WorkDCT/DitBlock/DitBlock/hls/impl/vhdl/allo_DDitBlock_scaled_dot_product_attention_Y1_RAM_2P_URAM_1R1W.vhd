...
entity allo_DDitBlock_scaled_dot_product_attention_Y1_RAM_2P_URAM_1R1W is 
    generic(
        MEM_TYPE        : string    := "hls_ultra"; 
        DataWidth       : integer   := 32; 
        AddressWidth    : integer   := 20;
        AddressRange    : integer   := 1048576
    ); 
    port (
...
architecture rtl of allo_DDitBlock_scaled_dot_product_attention_Y1_RAM_2P_URAM_1R1W is 
