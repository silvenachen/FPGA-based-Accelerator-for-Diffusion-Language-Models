...
wire   [0:0] icmp_ln310_fu_110_p2;
reg   [0:0] icmp_ln310_reg_164_pp0_iter1_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage1_01001) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln310_reg_164_pp0_iter1_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (icmp_ln310_reg_164 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln310_reg_164 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        A_fifo_7_read = 1'b1;
    end else begin
        A_fifo_7_read = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_subdone) & (icmp_ln310_reg_164 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln310_reg_164_pp0_iter1_reg == 1'd1))) begin
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = (((icmp_ln310_reg_164 == 1'd0) & (1'b0 == B_fifo_7_1_full_n)) | ((icmp_ln310_reg_164 == 1'd0) & (1'b0 == A_fifo_8_full_n)) | ((icmp_ln310_reg_164 == 1'd0) & (1'b0 == B_fifo_7_0_empty_n)) | ((icmp_ln310_reg_164 == 1'd0) & (1'b0 == A_fifo_7_empty_n)));
end

always @ (*) begin
    ap_condition_257 = ((1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln310_reg_164 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage1));
end
...
assign icmp_ln310_fu_110_p2 = ((ap_sig_allocacmp_k7_1 == 8'd128) ? 1'b1 : 1'b0);
