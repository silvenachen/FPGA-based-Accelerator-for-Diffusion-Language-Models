...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename adaLN_bias \
    op interface \
    ports { adaLN_bias_address0 { O 9 vector } adaLN_bias_ce0 { O 1 bit } adaLN_bias_we0 { O 1 bit } adaLN_bias_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'adaLN_bias'"
}
}
