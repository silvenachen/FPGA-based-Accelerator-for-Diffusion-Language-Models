...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buffer0 \
    op interface \
    ports { buffer0_address0 { O 9 vector } buffer0_ce0 { O 1 bit } buffer0_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buffer0'"
}
}
