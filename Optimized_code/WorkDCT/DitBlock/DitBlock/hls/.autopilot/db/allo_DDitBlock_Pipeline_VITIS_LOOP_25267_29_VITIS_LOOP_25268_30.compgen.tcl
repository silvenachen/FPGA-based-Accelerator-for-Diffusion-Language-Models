...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buffer_sin \
    op interface \
    ports { buffer_sin_address0 { O 15 vector } buffer_sin_ce0 { O 1 bit } buffer_sin_we0 { O 1 bit } buffer_sin_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buffer_sin'"
}
}
