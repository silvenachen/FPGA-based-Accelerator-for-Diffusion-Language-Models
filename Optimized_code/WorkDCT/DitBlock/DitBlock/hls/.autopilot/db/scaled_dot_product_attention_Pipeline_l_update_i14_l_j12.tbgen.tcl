...
set C_modelArgList {
	...
	{ Y_t float 32 regular {array 1048576 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ Y_t_address0 sc_out sc_lv 20 signal 1 } 
	{ Y_t_ce0 sc_out sc_logic 1 signal 1 } 
	{ Y_t_we0 sc_out sc_logic 1 signal 1 } 
	{ Y_t_d0 sc_out sc_lv 32 signal 1 } 
	{ Y_t_address1 sc_out sc_lv 20 signal 1 } 
	{ Y_t_ce1 sc_out sc_logic 1 signal 1 } 
	{ Y_t_q1 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Y_t_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "Y_t", "role": "address1" }} , 
 	{ "name": "Y_t_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Y_t", "role": "ce1" }} , 
 	{ "name": "Y_t_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Y_t", "role": "q1" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fdiv_32ns_32ns_32_6_no_dsp_1_U2092", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	Y_t { ap_memory {  { Y_t_address0 mem_address 1 20 }  { Y_t_ce0 mem_ce 1 1 }  { Y_t_we0 mem_we 1 1 }  { Y_t_d0 mem_din 1 32 }  { Y_t_address1 MemPortADDR2 1 20 }  { Y_t_ce1 MemPortCE2 1 1 }  { Y_t_q1 MemPortDOUT2 0 32 } } }
}
