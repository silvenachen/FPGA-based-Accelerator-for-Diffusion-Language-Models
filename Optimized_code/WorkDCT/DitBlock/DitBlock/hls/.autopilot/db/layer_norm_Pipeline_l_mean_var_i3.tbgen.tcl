set moduleName layer_norm_Pipeline_l_mean_var_i3
set isTopModule 0
...
set C_modelName {layer_norm_Pipeline_l_mean_var_i3}
set C_modelType { void 0 }
set C_modelArgList {
	{ mean float 32 regular {array 1024 { 0 1 } 1 1 }  }
	{ mean2 float 32 regular {array 1024 { 0 1 } 1 1 }  }
	{ var_r float 32 regular {array 1024 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "mean", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "var_r", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ mean_address0 sc_out sc_lv 10 signal 0 } 
	{ mean_ce0 sc_out sc_logic 1 signal 0 } 
	{ mean_we0 sc_out sc_logic 1 signal 0 } 
	{ mean_d0 sc_out sc_lv 32 signal 0 } 
	{ mean_address1 sc_out sc_lv 10 signal 0 } 
	{ mean_ce1 sc_out sc_logic 1 signal 0 } 
	{ mean_q1 sc_in sc_lv 32 signal 0 } 
	{ mean2_address0 sc_out sc_lv 10 signal 1 } 
	{ mean2_ce0 sc_out sc_logic 1 signal 1 } 
	{ mean2_we0 sc_out sc_logic 1 signal 1 } 
	{ mean2_d0 sc_out sc_lv 32 signal 1 } 
	{ mean2_address1 sc_out sc_lv 10 signal 1 } 
	{ mean2_ce1 sc_out sc_logic 1 signal 1 } 
	{ mean2_q1 sc_in sc_lv 32 signal 1 } 
	{ var_r_address0 sc_out sc_lv 10 signal 2 } 
	{ var_r_ce0 sc_out sc_logic 1 signal 2 } 
	{ var_r_we0 sc_out sc_logic 1 signal 2 } 
	{ var_r_d0 sc_out sc_lv 32 signal 2 } 
	{ grp_fu_251_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_251_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_251_p_dout0 sc_in sc_lv 32 signal -1 } 
	...
	{ grp_fu_247_p_opcode sc_out sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mean_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mean", "role": "address1" }} , 
 	...
 	{ "name": "var_r_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "var_r", "role": "address0" }} , 
 	{ "name": "var_r_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "var_r", "role": "ce0" }} , 
 	{ "name": "var_r_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "var_r", "role": "we0" }} , 
 	{ "name": "var_r_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "var_r", "role": "d0" }} , 
 	{ "name": "grp_fu_251_p_din0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_251_p_din0", "role": "default" }} , 
 	{ "name": "grp_fu_251_p_din1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_251_p_din1", "role": "default" }} , 
 	{ "name": "grp_fu_251_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_251_p_dout0", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_247_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_247_p_opcode", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_2_max_dsp_1_U210", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_2_max_dsp_1_U211", "Parent" : "0"},
...
set Spec2ImplPortList { 
	mean { ap_memory {  { mean_address0 mem_address 1 10 }  { mean_ce0 mem_ce 1 1 }  { mean_we0 mem_we 1 1 }  { mean_d0 mem_din 1 32 }  { mean_address1 MemPortADDR2 1 10 }  { mean_ce1 MemPortCE2 1 1 }  { mean_q1 in_data 0 32 } } }
	mean2 { ap_memory {  { mean2_address0 mem_address 1 10 }  { mean2_ce0 mem_ce 1 1 }  { mean2_we0 mem_we 1 1 }  { mean2_d0 mem_din 1 32 }  { mean2_address1 MemPortADDR2 1 10 }  { mean2_ce1 MemPortCE2 1 1 }  { mean2_q1 in_data 0 32 } } }
	var_r { ap_memory {  { var_r_address0 mem_address 1 10 }  { var_r_ce0 mem_ce 1 1 }  { var_r_we0 mem_we 1 1 }  { var_r_d0 mem_din 1 32 } } }
}
