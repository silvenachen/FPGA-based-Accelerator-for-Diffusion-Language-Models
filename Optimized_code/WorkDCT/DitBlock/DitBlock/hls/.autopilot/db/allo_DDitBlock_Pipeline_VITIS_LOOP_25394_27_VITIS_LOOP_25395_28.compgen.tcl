...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buffer_w \
    op interface \
    ports { buffer_w_address1 { O 18 vector } buffer_w_ce1 { O 1 bit } buffer_w_we1 { O 1 bit } buffer_w_d1 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buffer_w'"
}
}
