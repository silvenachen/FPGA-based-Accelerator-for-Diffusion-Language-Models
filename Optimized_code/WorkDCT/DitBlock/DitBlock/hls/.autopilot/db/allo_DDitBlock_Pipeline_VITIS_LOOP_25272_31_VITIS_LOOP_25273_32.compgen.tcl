...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buffer_cos \
    op interface \
    ports { buffer_cos_address0 { O 15 vector } buffer_cos_ce0 { O 1 bit } buffer_cos_we0 { O 1 bit } buffer_cos_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buffer_cos'"
}
}
