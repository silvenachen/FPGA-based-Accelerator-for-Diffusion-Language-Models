...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buffer_c_0 \
    op interface \
    ports { buffer_c_0_address0 { O 7 vector } buffer_c_0_ce0 { O 1 bit } buffer_c_0_we0 { O 1 bit } buffer_c_0_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buffer_c_0'"
}
}
