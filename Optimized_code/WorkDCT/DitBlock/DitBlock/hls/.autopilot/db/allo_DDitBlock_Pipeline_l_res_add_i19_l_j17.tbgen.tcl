...
set C_modelArgList {
	...
	{ buffer_V float 32 regular {array 524288 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "buffer_x", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "buffer_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ buffer_V_address0 sc_out sc_lv 19 signal 1 } 
	{ buffer_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ buffer_V_q0 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buffer_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "buffer_V", "role": "address0" }} , 
 	{ "name": "buffer_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buffer_V", "role": "ce0" }} , 
 	{ "name": "buffer_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buffer_V", "role": "q0" }} , 
...
set ArgLastReadFirstWriteLatency {
	allo_DDitBlock_Pipeline_l_res_add_i19_l_j17 {
		buffer_x {Type IO LastRead 1 FirstWrite 6}
...
set Spec2ImplPortList { 
	...
	buffer_V { ap_memory {  { buffer_V_address0 mem_address 1 19 }  { buffer_V_ce0 mem_ce 1 1 }  { buffer_V_q0 mem_dout 0 32 } } }
}
