...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buffer2 \
    op interface \
    ports { buffer2_address0 { O 9 vector } buffer2_ce0 { O 1 bit } buffer2_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buffer2'"
}
}
