...
set C_modelArgList {
	...
	{ Y_t float 32 regular {array 1048576 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "Y1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "Y_t", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1048580", "Max" : "1048580"}
	, {"Name" : "Interval", "Min" : "1048580", "Max" : "1048580"}
]}
...
set Spec2ImplPortList { 
	...
	Y_t { ap_memory {  { Y_t_address0 mem_address 1 20 }  { Y_t_ce0 mem_ce 1 1 }  { Y_t_we0 mem_we 1 1 }  { Y_t_d0 mem_din 1 32 } } }
}
