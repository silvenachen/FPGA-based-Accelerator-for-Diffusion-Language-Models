set moduleName allo_DDitBlock_Pipeline_l_scale_i18_l_j1610
set isTopModule 0
...
set C_modelName {allo_DDitBlock_Pipeline_l_scale_i18_l_j1610}
set C_modelType { void 0 }
set C_modelArgList {
	{ buffer_Q float 32 regular {array 524288 { 1 0 } 1 1 }  }
	{ buffer5 float 32 regular {array 512 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "buffer_Q", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "buffer5", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ buffer5_address0 sc_out sc_lv 9 signal 1 } 
	{ buffer5_ce0 sc_out sc_logic 1 signal 1 } 
	{ buffer5_q0 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buffer5_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "buffer5", "role": "address0" }} , 
 	{ "name": "buffer5_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buffer5", "role": "ce0" }} , 
 	{ "name": "buffer5_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buffer5", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "allo_DDitBlock_Pipeline_l_scale_i18_l_j1610",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "buffer5", "Type" : "Memory", "Direction" : "I"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	allo_DDitBlock_Pipeline_l_scale_i18_l_j1610 {
		buffer_Q {Type IO LastRead 1 FirstWrite 5}
		buffer5 {Type I LastRead 2 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	buffer5 { ap_memory {  { buffer5_address0 mem_address 1 9 }  { buffer5_ce0 mem_ce 1 1 }  { buffer5_q0 in_data 0 32 } } }
}
