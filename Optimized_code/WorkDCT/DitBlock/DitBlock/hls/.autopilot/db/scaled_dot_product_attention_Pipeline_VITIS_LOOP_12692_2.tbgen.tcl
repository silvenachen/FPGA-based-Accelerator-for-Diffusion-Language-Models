set moduleName scaled_dot_product_attention_Pipeline_VITIS_LOOP_12692_2
set isTopModule 0
...
set C_modelName {scaled_dot_product_attention_Pipeline_VITIS_LOOP_12692_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ S float 32 regular {array 1024 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
