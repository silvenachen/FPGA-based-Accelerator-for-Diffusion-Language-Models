...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename adaLN_weight \
    op interface \
    ports { adaLN_weight_address0 { O 16 vector } adaLN_weight_ce0 { O 1 bit } adaLN_weight_we0 { O 1 bit } adaLN_weight_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'adaLN_weight'"
}
}
