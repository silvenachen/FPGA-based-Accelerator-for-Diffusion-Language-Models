set moduleName allo_DDitBlock_Pipeline_l_m_fused_i5_l_j38
set isTopModule 0
...
set C_modelName {allo_DDitBlock_Pipeline_l_m_fused_i5_l_j38}
...
set portList { 
	...
	{ buffer4_address0 sc_out sc_lv 9 signal 2 } 
	{ buffer4_ce0 sc_out sc_logic 1 signal 2 } 
	{ buffer4_q0 sc_in sc_lv 32 signal 2 } 
	{ buffer3_address0 sc_out sc_lv 9 signal 3 } 
	{ buffer3_ce0 sc_out sc_logic 1 signal 3 } 
	{ buffer3_q0 sc_in sc_lv 32 signal 3 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "allo_DDitBlock_Pipeline_l_m_fused_i5_l_j38",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	allo_DDitBlock_Pipeline_l_m_fused_i5_l_j38 {
		buffer_Q {Type I LastRead 3 FirstWrite -1}
		buffer_K {Type O LastRead -1 FirstWrite 10}
