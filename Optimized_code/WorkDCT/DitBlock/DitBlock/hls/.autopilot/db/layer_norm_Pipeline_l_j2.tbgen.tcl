...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln655", "interface" : "wire", "bitwidth" : 19, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln655 sc_in sc_lv 19 signal 0 } 
	{ v262_address0 sc_out sc_lv 19 signal 1 } 
	{ v262_ce0 sc_out sc_logic 1 signal 1 } 
	{ v262_q0 sc_in sc_lv 32 signal 1 } 
	{ v265_address1 sc_out sc_lv 19 signal 2 } 
	{ v265_ce1 sc_out sc_logic 1 signal 2 } 
	{ v265_we1 sc_out sc_logic 1 signal 2 } 
	{ v265_d1 sc_out sc_lv 32 signal 2 } 
	{ v293 sc_in sc_lv 32 signal 3 } 
	{ v298 sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln655", "direction": "in", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "zext_ln655", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_3_full_dsp_1_U217", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fdiv_32ns_32ns_32_6_no_dsp_1_U218", "Parent" : "0"},
...
set Spec2ImplPortList { 
	zext_ln655 { ap_none {  { zext_ln655 in_data 0 19 } } }
